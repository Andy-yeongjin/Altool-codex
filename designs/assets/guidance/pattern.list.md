...
- G01: 중요한 항목은 상단에 배치한다.
- G02: 관련 항목을 의미 단위로 묶고 논리적 순서를 유지한다.
- G03: 항목 사이 간격·구분선으로 구분하되 강조 장식은 과도하게 사용하지 않는다.
- G04: 긴 목록은 페이지로 나누고 페이지당 기본 10개 이상을 표시한다.
- G05: 많은 항목은 검색·필터로 탐색할 수 있게 한다.
