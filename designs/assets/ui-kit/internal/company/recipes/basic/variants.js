...
(function(){
  ...
  if(document.body.dataset.variant==='filter-layouts'){
    ...
    $('variant-reset').addEventListener('click',()=>{applied={keyword:'',category:'',from:'',to:'',sort:'newest'};page=1;$('variant-sort').value='newest';fillApplied();render();globalThis.CompanyRecipeControls?.refresh();});
